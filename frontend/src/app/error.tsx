    ...
    <div style={{ background: "#0a0f1e", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "0 24px" }}>
      <div style={{ textAlign: "center", maxWidth: 480 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <button
            onClick={reset}
            style={{ padding: "12px 28px", background: "#00d4ff", color: "#0a0f1e", fontWeight: 700, fontSize: 14, borderRadius: 10, border: "none", cursor: "pointer" }}
          >
            Try Again
          </button>
          <Link href="/" style={{ padding: "12px 28px", border: "1px solid #1e2d40", color: "#f1f5f9", fontWeight: 600, fontSize: 14, borderRadius: 10, textDecoration: "none" }}>
            Go Home
          </Link>
        </div>
      </div>
