      ...
      <div style={{ maxWidth: 900, width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
          <button
            ...
            style={{ padding: "8px 16px", border: "1px solid #1c3050", background: "transparent", color: "#94a3b8", fontSize: 12, fontWeight: 600, borderRadius: 8, cursor: "pointer" }}
          >
            Necessary Only
          </button>
          <button
            onClick={accept}
            style={{ padding: "8px 16px", background: "#38bdf8", color: "#080f1e", fontSize: 12, fontWeight: 700, borderRadius: 8, border: "none", cursor: "pointer" }}
          >
            Accept All
          </button>
        </div>
