  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 900, width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
        <p style={{ fontSize: 13, color: "var(--text-muted)", margin: 0, flex: 1, minWidth: 200 }}>
        ...
        <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
          <button
            ...
            style={{ padding: "8px 16px", border: "1px solid var(--border-light)", background: "transparent", color: "var(--text-muted)", fontSize: 12, fontWeight: 600, borderRadius: 8, cursor: "pointer" }}
          >
            Necessary Only
          </button>
          <button
            onClick={accept}
            style={{ padding: "8px 16px", background: "var(--navy)", color: "#fff", fontSize: 12, fontWeight: 700, borderRadius: 8, border: "none", cursor: "pointer" }}
          >
            Accept All
          </button>
        </div>
