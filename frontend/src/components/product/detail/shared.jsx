...
export const BADGE_COLORS = {
  "Electric Vehicles": "#0f4c81",
  Batteries: "#5b21b6",
  "Home Appliances": "#1a7a4a",
  "Industrial Equipment": "#c17f24",
  "Industrial Components": "#c17f24",
  Electronics: "#6b5a45",
...
export function StarRating({ rating, size = 14 }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
      {[1, 2, 3, 4, 5].map((s) => (
        <svg key={s} viewBox="0 0 20 20" fill={s <= Math.round(rating) ? "#c17f24" : "none"} stroke="#c17f24" strokeWidth={1.5} style={{ width: size, height: size }}>
