  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      >
        ...
        <div style={{ position: "relative", width: "85%", height: 280, filter: "drop-shadow(0 4px 20px rgba(0,212,255,0.15))" }}>
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
          {images.map((img, idx) => (
            <button
              ...
              style={{ width: 64, height: 64, borderRadius: 8, border: `2px solid ${activeImage === idx ? "#00d4ff" : "#1e2d40"}`, background: "#111827", cursor: "pointer", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", padding: 4, transition: "border-color 0.2s", position: "relative" }}
            >
