...
export default function ProductImageGallery({ images, productName, isNew }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      <div
        style={{ background: "var(--bg-card)", border: "1px solid var(--border-light)", borderRadius: 20, padding: 32, display: "flex", alignItems: "center", justifyContent: "center", minHeight: 340, position: "relative", cursor: "zoom-in" }}
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
          {images.map((img, idx) => (
            <button
              ...
              style={{ width: 64, height: 64, borderRadius: 8, border: `2px solid ${activeImage === idx ? "var(--navy)" : "var(--border-light)"}`, background: "var(--bg-surface)", cursor: "pointer", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", padding: 4, transition: "border-color 0.2s", position: "relative" }}
            >
