...
const TABS = ["All", "EV Scooters", "E-Rickshaws", "Batteries", "Appliances", "Solar"];

const CATEGORY_MAP = {
  All: null,
  "EV Scooters": "Electric Vehicles",
  "E-Rickshaws": "Electric Vehicles",
  Batteries: "Batteries",
...
const FILTER_FN = {
  All: () => true,
  "EV Scooters": (p) => p.category === "Electric Vehicles" && p.slug === "electric-scooter",
  "E-Rickshaws": (p) => p.slug === "e-rickshaw",
  Batteries: (p) => p.category === "Batteries",
  Appliances: (p) => p.category === "Home Appliances",
  Solar: (p) => false,
};
    ...
    >
      <motion.div
        ...
        style={{
          ...
          perspective: "800px",
          background: "#0f172a",
          border: `1px solid ${hovered ? "rgba(0,212,255,0.2)" : "#1e2d40"}`,
          borderRadius: 16,
          overflow: "hidden",
      ...
      >
        ...
        {/* Footer */}
        <div style={{ padding: "16px 20px", borderTop: "1px solid #1e2d40", display: "flex", gap: 8 }}>
          <Link
          ...
          <button
            style={{
              ...
              color: "#94a3b8", transition: "all 0.2s", display: "flex", alignItems: "center",
            }}
...
export default function FeaturedProducts() {
  ...
  const filtered = activeTab === "All"
    ? products.slice(0, 6)
    : products.filter(filterFn).slice(0, 6);
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{ fontSize: 15, color: "#94a3b8", maxWidth: 560, margin: "0 auto", lineHeight: 1.7 }}>
            Every scooter, rickshaw, and battery that leaves our Bhubaneswar factory has passed
            47 quality checks. No exceptions.
          </p>
        </motion.div>
