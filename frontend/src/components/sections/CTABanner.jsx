...
export default function CTABanner() {
  return (
    <section style={{
      ...
      {/* Layer 2 — cyan radial glow top-right */}
      <div style={{
      ...
      {/* Layer 3 — purple radial glow bottom-left */}
      <div style={{
      ...
      <div style={{
        ...
        backgroundImage: "linear-gradient(rgba(30,45,64,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(30,45,64,0.3) 1px, transparent 1px)",
      ...
      {FLOATING_CHIPS.map((chip, i) => (
        <motion.div
          ...
          style={{
            ...
            background: "rgba(15,23,42,0.9)", border: "1px solid #1e2d40",
            borderRadius: 100, padding: "8px 16px", fontSize: 12, fontWeight: 600,
            color: "#94a3b8", whiteSpace: "nowrap", opacity: 0.7,
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 700, margin: "0 auto", width: "100%" }}>
        ...
        >
          <h2 style={{ fontWeight: 900, lineHeight: 1.15, margin: 0 }}>
            <span style={{ display: "block", fontSize: "clamp(40px, 6vw, 68px)", color: "#f1f5f9" }}>One call.</span>
            <span style={{
              display: "block", fontSize: "clamp(40px, 6vw, 68px)",
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          style={{ fontSize: 17, color: "#94a3b8", lineHeight: 1.8, maxWidth: 580, margin: "0 auto 40px" }}
        >
        ...
        >
          <Link href="/products" style={{
            display: "inline-flex", alignItems: "center", gap: 8,
            padding: "16px 32px", background: "#00d4ff", color: "#0a0f1e",
            fontWeight: 800, fontSize: 15, borderRadius: 12, textDecoration: "none",
            transition: "all 0.2s", boxShadow: "0 0 24px rgba(0,212,255,0.3)",
          }}
          ...
          <Link href="/services/enquiry" style={{
            display: "inline-flex", alignItems: "center", gap: 8,
            padding: "16px 32px", background: "#7c3aed", color: "#fff",
          ...
          <Link href="/battery-swap" style={{
            display: "inline-flex", alignItems: "center", gap: 8,
            padding: "16px 32px", background: "transparent", color: "#00d4ff",
            fontWeight: 700, fontSize: 15, borderRadius: 12, textDecoration: "none",
            border: "1px solid rgba(0,212,255,0.4)", transition: "all 0.2s",
          }}
        ...
        >
          ...
          <a href="tel:+919437611129" style={{
            fontSize: "clamp(22px, 3vw, 30px)", fontWeight: 900, color: "#f1f5f9",
          ...
          <p style={{ fontSize: 12, color: "#475569", margin: "6px 0 0" }}>Mon–Sat · 8AM–8PM IST</p>
        </motion.div>
      </div>
