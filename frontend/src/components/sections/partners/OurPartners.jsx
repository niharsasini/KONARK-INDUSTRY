...
const PARTNERS = [
  { name: "OPTCL", full: "Odisha Power Transmission Corporation Ltd.", color: "#38bdf8" },
  { name: "NALCO", full: "National Aluminium Company Limited", color: "#818cf8" },
...
function PartnerCard({ partner, index, inView }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: "#0c1525",
        border: `1px solid ${hovered ? partner.color + "60" : "#1c3050"}`,
        borderRadius: 16,
        textAlign: "center",
  ...
  return (
    <section style={{ background: "transparent", padding: "100px 24px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        >
          <span style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 14px", borderRadius: 999, border: "1px solid rgba(56,189,248,0.3)", color: "#38bdf8", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.12em", background: "rgba(56,189,248,0.08)", marginBottom: 16 }}>Our Partners</span>
          <h2 style={{ fontSize: "clamp(26px, 3.5vw, 44px)", fontWeight: 900, margin: "0 0 12px", lineHeight: 1.2 }}>
            ...
            <span style={{ background: "linear-gradient(135deg, #38bdf8, #818cf8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Industry Leaders</span>
          </h2>
        ...
        <motion.div
          ...
          style={{ background: "#0c1525", border: "1px solid #1c3050", borderRadius: 16, padding: "28px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 20 }}
        >
          <div>
            <p style={{ fontSize: 17, fontWeight: 700, color: "#f1f5f9", margin: "0 0 4px" }}>Want to distribute Konark products in your area?</p>
            <p style={{ fontSize: 14, color: "#64748b", margin: 0 }}>Join our growing network of distributors and service partners across Odisha.</p>
          </div>
          <Link href="/partner" style={{ padding: "12px 26px", background: "#38bdf8", color: "#080f1e", fontWeight: 700, fontSize: 14, borderRadius: 10, textDecoration: "none", whiteSpace: "nowrap", transition: "background 0.2s", minHeight: 44, display: "inline-flex", alignItems: "center" }}
