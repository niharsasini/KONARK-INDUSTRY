...
export default function EditProductPage() {
  ...
  if (fetching) {
    return <div style={{ padding: "32px 40px", color: "var(--text-muted)" }}>Loading product...</div>;
  }
  ...
  return (
    <div style={{ padding: "32px 40px", maxWidth: 800 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <h1 style={{ fontSize: 26, fontWeight: 800, color: "var(--text-heading)", margin: 0 }}>Edit Product</h1>
      </div>
